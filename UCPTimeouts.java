...
public class UCPTimeouts {
  final static String DEFAULT_URL = "jdbc:oracle:thin:@//192.168.194.5:1521/INVENTORYPDB";
  final static String DEFAULT_USER = "SCH_HELLOWORLD";
  final static String DEFAULT_PASSWORD = "SCH_HELLOWORLD";
